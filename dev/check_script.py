...
# 逐集实测（五季全量，按下面的 INTERJ 口径）：
#   agent 语气词轮 18-43% · 感叹号 0-3  · 问号 15-27   ← S1，最克制，也是最自然的一季
#   tools           51-93% ·        3-15 ·       10-31
#   rag             52-72% ·        4-15 ·       11-31
#   llm             51-68% ·        4-12 ·       19-48
#   langchain       53-69% ·        4-11 ·       18-26
# 原来的带是 (0.51,0.93)/(3,15)，正好等于「除 S1 外的所有季」—— 它会把 S1 自己打回去，
# 等于逼着每一季都写成 S2 的外放腔调。下限改按五季合并最小值取。
# 另注意 INTERJ 里的省略号/破折号对 TTS 无效，只影响字幕，别靠堆它们凑这个数。
BANDS = {"语气词轮": (0.18, 0.93), "感叹号": (0, 15), "问号": (10, 48),
